 ...
 */
public class AssemblyQualityPlugin extends Plugin {
	 ...
	 * for each pipeline).
	 */
	public static final AnalysisType ASSEMBLY_QUALITY = new AnalysisType("ASSEMBLY_QUALITY");

	public AssemblyQualityPlugin(PluginWrapper wrapper) {
		super(wrapper);
	}
	...
	public static class PluginInfo implements IridaPlugin {
		...
		public UUID getDefaultWorkflowUUID() {
			return UUID.fromString("093a602b-11b1-46ca-a140-9163fed6e9fa");
		}
